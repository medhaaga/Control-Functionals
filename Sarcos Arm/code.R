...
for (k in 1:length(ns)){
  ...
  save(mu_bar, mu_ZV, mu_CF, mu_CF_simp, file = "objects/means_n100.Rdata")
}
stop <- Sys.time()
print(stop - start)
...
boxplot(list("AM" = mu_bar[2,,1], "ZVCV" = mu_ZV[2,,1], "CF" = mu_CF[2,,1], "CF_simp" = mu_CF_simp[2,,1]), ylim = c(-0.4,-0.25))
boxplot(list("AM" = mu_bar[2,,2], "ZVCV" = mu_ZV[2,,2], "CF" = mu_CF[2,,2], "CF_simp" = mu_CF_simp[2,,2]), ylim = c(-0.4,-0.25))
boxplot(list("AM" = mu_bar[2,,3], "ZVCV" = mu_ZV[2,,3], "CF" = mu_CF[2,,3], "CF_simp" = mu_CF_simp[2,,3]), ylim = c(-0.4,-0.25))
